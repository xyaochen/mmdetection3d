...
model = dict(
    ...
    pts_neck=dict(
        ...
        num_outs=4),
    pts_bbox_head=dict(
        type='DeformableFUTR3DSplitHeadLiDAR',
        num_query=600,
        num_classes=10,
        in_channels=256,
        ...
        transformer=dict(
            ...
            decoder=dict(
                type='FUTR3DTransformerSplitDecoderLiDAR',
                num_layers=6,
...
#load_from = '/public/MARS/models/surrdet/points_model/centerpoint_01voxel.pth'
load_from = '/home/chenxy/centerpoint/mmdetection3d/work_dirs/centerpoint_01voxel_fade_step_20e/epoch_2.pth'