...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        as_two_stage=False,
        transformer=dict(
            type='FUTR3DTransformerInitLiDAR',
            decoder=dict(
                type='FUTR3DTransformerDenseSplitDecoderLiDAR',
                num_layers=6,
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        dict(
                            type='MultiheadAttentionLiDAR',
                            embed_dims=256,
                            num_heads=8,
                            dropout=0.1),
                        dict(
                            type='FUTR3DCrossAttenLiDARWPos',
