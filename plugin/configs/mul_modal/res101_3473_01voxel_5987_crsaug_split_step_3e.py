...
model = dict(
    ...
    pts_neck=dict(
        ...
        num_outs=4),
    pts_bbox_head=dict(
        type='DeformableFUTR3DSplitHeadCamLiDAR',
        num_query=600,
        num_classes=10,
        in_channels=256,
        ...
        as_two_stage=False,
        transformer=dict(
            type='FUTR3DTransformerCamLiDAR',
            decoder=dict(
                type='FUTR3DTransformerSplitDecoderCamLiDAR',
                num_layers=6,
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        dict(
                            ...
                            dropout=0.1),
                        dict(
                            type='FUTR3DCrossAttenCamLiDARAug',
...
train_pipeline = [
    ...
    dict(
        type='PointGlobalRotScaleTrans',
        rot_range=[-0.3925, 0.3925],
        scale_ratio_range=[0.95, 1.05],
        translation_std=[0, 0, 0]),
    dict(
        type='PointRandomFlip3D',
        sync_2d=False,
...
load_from = '/public/MARS/models/surrdet/pts_img_models/img_3473_pts_pre_split_5987_20e.pth'
