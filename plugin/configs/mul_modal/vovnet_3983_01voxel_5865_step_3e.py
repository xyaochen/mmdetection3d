...
model = dict(
    ...
    pts_neck=dict(
        ...
        num_outs=4),
    pts_bbox_head=dict(
        type='DeformableFUTR3DHeadCamLiDAR',
        num_query=600,
        num_classes=10,
        in_channels=256,
        ...
        transformer=dict(
            ...
            decoder=dict(
                type='FUTR3DTransformerDecoderCamLiDAR',
                num_layers=6,
...
load_from = '/public/MARS/models/surrdet/pts_img_models/vovnet_3985_01voxel_5865_step_3e.pth'
