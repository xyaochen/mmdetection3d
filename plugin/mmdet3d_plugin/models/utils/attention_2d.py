...
def feature_sampling_2D(mlvl_feats, reference_points, pc_range):
...
class FUTR3DCrossAttenLiDAR2D(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 **kwargs):
        super(FUTR3DCrossAttenLiDAR2D, self).__init__(init_cfg)
    ...
    def forward(self,
        ...
        pts_output= feature_sampling_2D(
