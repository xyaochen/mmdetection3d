...
class FUTR3DTransformerCam(BaseModule):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(FUTR3DTransformerCam, self).__init__(**kwargs)
...
class FUTR3DTransformerDecoderCam(TransformerLayerSequence):
    ...
    def __init__(self, *args, return_intermediate=False,  **kwargs):
        ...
        super(FUTR3DTransformerDecoderCam, self).__init__(*args, **kwargs)
