...
class FUTR3DInitHeadLiDAR(DETRHead):
    ...
    def __init__(self,
        ...
        super(FUTR3DInitHeadLiDAR, self).__init__(
    ...
    def forward(self, mlvl_pts_feats, img_metas):
        ...
        if self.initialize_by_heatmap:
            ...
            # print(query_score)
            #print('query_score', query_score.size())
    ...
    def loss(self,
        ...
        losses_cls, losses_bbox, losses_heatmap = multi_apply(
            self.loss_single, query_cls_scores, all_bbox_preds,
            dense_heatmap_list, 
