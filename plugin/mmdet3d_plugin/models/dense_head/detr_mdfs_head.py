...
class DeformableFUTR3DHeadCamLiDAR(DETRHead):
    ...
    def __init__(self,
        ...
        super(DeformableFUTR3DHeadCamLiDAR, self).__init__(
...
@HEADS.register_module()
class DeformableFUTR3DSplitHeadCamLiDAR(DETRHead):
    """Head of DeformDETR3DCam. 
    Args:
        with_box_refine (bool): Whether to refine the reference points
            in the decoder. Defaults to False.
    ...
    def __init__(self,
        ...
        self.num_cls_fcs = num_cls_fcs - 1
        super(DeformableFUTR3DSplitHeadCamLiDAR, self).__init__(
            *args, transformer=transformer, **kwargs)
        self.code_weights = nn.Parameter(torch.tensor(
            self.code_weights, requires_grad=False), requires_grad=False)
        self.per_scene_noise = per_scene_noise
    ...
    def forward(self, mlvl_pts_feats, mlvl_img_feats, img_metas):
        ...
        for lvl in range(hs.shape[0]):
            ...
            tmp = torch.cat((offset[..., :2], bbox_sz[..., :2], offset[..., 2:3], 
