...
class DeformableFUTR3DEnc2StageHeadLiDAR(DETRHead):
    ...
    def __init__(self,
        ...
        super(DeformableFUTR3DEnc2StageHeadLiDAR, self).__init__(
    ...
    def forward(self, mlvl_pts_feats, img_metas):
        ...
        img_masks = mlvl_pts_feats[0].new_zeros(
            (batch_size, input_img_h, input_img_w))

        mlvl_masks = []
        mlvl_positional_encodings = []
        for feat in mlvl_pts_feats:
            mlvl_masks.append(
        ...
        mlvl_pts_feats = [feat.squeeze(dim=1) for feat in mlvl_pts_feats]
    ...
    def loss(self,
        ...
        loss_dict = dict()
        #print(num_dec_layers, len(gt_labels_list))
