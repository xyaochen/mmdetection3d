...
class ResidualConv(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride, dropout=None):
        ...
        if dropout:
            ...
            # Note: replace above with commented line below for backwards compatibility. TODO: fix this.
    ...
    def forward(self, x):
        ...
        # Note: comment lines below for backwards compatibility. TODO: fix this.
        if self.dropout:
